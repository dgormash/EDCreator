...
namespace FDCreator.Logic.Implementations
{
    public class StabilizerPdfProcessor:IPdfProcessor
    {
        ...
        private readonly IStabilizerParsedData _transferingData = new StabilizerParsedData();
        ...
        public IParsedData GetParsedDataFromPdf(string file)
        {
            ...
            var rect = new iTextSharp.text.Rectangle(411, 727, 436, 732);
            ...
            rect = new iTextSharp.text.Rectangle(137, 649, 160, 655);
            _transferingData.Length = _parser.GetStringValueFromRegion(file, rect);

            //Stabilizer OD
            //lx: 290.16; ly: 649.9265; rx: 306.4946; ry: 655.8065
            rect = new iTextSharp.text.Rectangle(290, 649, 306, 655);
            _transferingData.StabilizerOd = _parser.GetStringValueFromRegion(file, rect);

            //Lobe Length
            //lx: 295.08; ly: 642.1265; rx: 301.6186; ry: 648.0065
            rect = new iTextSharp.text.Rectangle(295, 642, 301, 648);
            _transferingData.LobeLength = _parser.GetStringValueFromRegion(file, rect);

            //Lobe Width
            //lx: 291.72; ly: 626.5266; rx: 304.7854; ry: 632.4065
            rect = new iTextSharp.text.Rectangle(291, 626, 304, 632);
            _transferingData.LobeWidth = _parser.GetStringValueFromRegion(file, rect);

            //Fishing neck/Tong space
            //lx: 437.16; ly: 531.1265; rx: 456.7639; ry: 537.0065
            rect = new iTextSharp.text.Rectangle(437, 531, 456, 537);
            _transferingData.FishingNeckTongSpace = _parser.GetStringValueFromRegion(file, rect);
            ...
            rect = new iTextSharp.text.Rectangle(29, 595, 124, 616);
            ...
            rect = new iTextSharp.text.Rectangle(106, 576, 122, 582);
            ...
            //???
            rect = new iTextSharp.text.Rectangle(106, 561, 122, 567);
            ...
            rect = new iTextSharp.text.Rectangle(245, 595, 345, 616);
            ...
            rect = new iTextSharp.text.Rectangle(328, 576, 345, 582);
